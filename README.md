...
## Dataset
Uses the [Lichess database of openings.](https://github.com/lichess-org/chess-openings) In this dataset, not all variations of every opening are prefixed with that opening's name. In particular, the Slav (D10) is notated simply as "Slav Defense." The search criteria for the Queen's Gambit needed several revisions to include every variation.
